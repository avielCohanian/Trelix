      ...
      <div class="login-container">
        <div class="login">
          ...
          <div class="login-password-container">
            <el-input placeholder="Enter email" type="email" v-model="userToLogIn.email"> </el-input>
            <el-input placeholder="Enter password" type="password" v-model="userToLogIn.password"> </el-input>
